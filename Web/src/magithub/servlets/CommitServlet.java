...
public class CommitServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String description = request.getParameter(Constants.COMMIT_DESCRIPTION);

        Gson gson = new Gson();
        String json = null;

        try {
            String statusLog = currentUser.getManager().commit(description).toString();
            json = ServletUtils.getJsonResponseString(statusLog, true);
        } catch (Exception e) {
