...
public class PullServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String branchToPull = request.getParameter(Constants.BRANCH_TO_PULL);

        Gson gson = new Gson();
        String json = null;

        try {
            magithubManager.pull(currentUserName);
            json = ServletUtils.getJsonResponseString(branchToPull + " pulled Successfully", true);
        } catch (Exception e) {
